...
AJS.toInit(function(F){D=AJS.InlineDialog(F("#shareContentLink"),"shareContentPopup",C,B)
    ...
    if (console && console.log) {
        console.log("Error loading resource (65642)");
        console.log(err);
    }
}
...
AJS.toInit(function ($) {
    ...
    if (console && console.log) {
        console.log("Error loading resource (16065)");
        console.log(err);
    }
}
...
AJS.toInit(function ($) {
    ...
    if (console && console.log) {
        console.log("Error loading resource (12901)");
        console.log(err);
    }
}
...
AJS.toInit(function($) {
    ...
    if (console && console.log) {
        console.log("Error loading resource (62146)");
        console.log(err);
    }
}
