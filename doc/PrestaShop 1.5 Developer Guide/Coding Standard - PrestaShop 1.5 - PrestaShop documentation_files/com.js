...
}}}function I(){if(!AJS.DarkFeatures.isEnabled("confluence.new-header")){Q()
...
}}}}var c=A("#"+V+"-anchor"),Z=c.outerHeight()-c.height(),Y=10+Z;
...
A("body").click(function(){anchorUtil.startRequests()
    ...
    if (console && console.log) {
        console.log("Error loading resource (66389)");
        console.log(err);
    }
}
...
M()
    ...
    if (console && console.log) {
        console.log("Error loading resource (33519)");
        console.log(err);
    }
}
